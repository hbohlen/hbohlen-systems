...
tags: [kiro-spec, workflow, design-review, validation]
category: kiro-spec
metadata:
  version: "1.0"
...
- Before running `/kiro-spec-tasks` to catch fundamental flaws early.
- Invoked as: `/kiro-validate-design <feature-name>`
...
- [`kiro-spec-design`](../kiro-spec-design/SKILL.md) — design generation (pre-review)
- [`kiro-spec-tasks`](../kiro-spec-tasks/SKILL.md) — next step after a GO decision

...
tags: [kiro-spec, steering, project-memory, custom]
category: kiro-spec
metadata:
  version: "1.0"
...
Create a custom domain-specific steering file under `.kiro/steering/`.
...
- Invoked as: `/kiro-steering-custom`
- Or: `/kiro-steering-custom <domain-name>` to target a specific file.
...
- Check if `.kiro/steering/<domain>.md` already exists.
...
### 5. Write to `.kiro/steering/<domain>.md`
...
- [`kiro-steering`](../kiro-steering/SKILL.md) — core steering setup

...
tags: [spec, workflow, gap-analysis, validation]
category: spec
metadata:
  version: "1.0"
  source: .agents/
...
- Invoked as: `/spec-validate-gap <feature-name>`
...
- [`spec-design`](../spec-design/SKILL.md) — next step after gap analysis
- [`spec-requirements`](../spec-requirements/SKILL.md) — prerequisites

...
export function registerCommands(
  ...
  pi.addCommand({
    ...
    handler: async (args: { agent?: string; task: string }, ctx: CommandContext): Promise<CommandResult> => {
  ...
  pi.addCommand({
    ...
    handler: async (_args: unknown, _ctx: CommandContext): Promise<CommandResult> => {
      try {
  ...
  pi.addCommand({
    ...
    handler: async (args: { index: number }): Promise<CommandResult> => {
      try {
  ...
  pi.addCommand({
    ...
    handler: async (args: { type: string }, ctx: CommandContext): Promise<CommandResult> => {
  ...
  pi.addCommand({
    ...
    handler: async (args: { all?: boolean }): Promise<CommandResult> => {
      try {
        if (args.all) {
  ...
  pi.addCommand({
    ...
    handler: async (args: { name?: string }): Promise<CommandResult> => {
      if (args.name) {
  ...
  pi.addCommand({
    ...
    handler: async (args: { query: string }, ctx: CommandContext): Promise<CommandResult> => {
      const config: SubagentConfig = {

...
1. **Load Context**:
   ...
   - Read `.agents/specs/$1/requirements.md` for requirements
...
2. **Read Analysis Guidelines**:
   - Read `.agents/rules/gap-analysis.md` for comprehensive analysis framework
...
### Error Scenarios
- **Missing Requirements**: If requirements.md doesn't exist, stop with message: "Run `/spec-requirements $1` first to generate requirements"

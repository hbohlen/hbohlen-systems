...
- `.agents/specs/$1/spec.json`, `requirements.md`, `design.md` (if exists)
- **Entire `.agents/steering/` directory** for complete project memory
- `.agents/templates/specs/design.md` for document structure
- `.agents/rules/design-principles.md` for design principles
- `.agents/templates/specs/research.md` for discovery log structure
...
2. **Execute Appropriate Discovery Process**:
   ...
   **For Complex/New Features**:
   - Read and execute `.agents/rules/design-discovery-full.md`
   ...
   **For Extensions**:
   - Read and execute `.agents/rules/design-discovery-light.md`
...
- Create or update `.agents/specs/$1/research.md` using the shared template
...
- Read `.agents/templates/specs/design.md` for structure
- Read `.agents/rules/design-principles.md` for principles
...
1. **Status**: Confirm design document generated at `.agents/specs/$1/design.md`
...
**Note**: The actual design document follows `.agents/templates/specs/design.md` structure.
...
- **User Message**: "No requirements.md found at `.agents/specs/$1/requirements.md`"
- **Suggested Action**: "Run `/spec-requirements $1` to generate requirements first"

**Template Missing**:
- **User Message**: "Template file missing at `.agents/templates/specs/design.md`"
...
- **Default**: Use full discovery process (`.agents/rules/design-discovery-full.md`)
...
**If Design Approved**:
- Review generated design at `.agents/specs/$1/design.md`
- **Optional**: Run `/spec-validate-design $1` for interactive quality review

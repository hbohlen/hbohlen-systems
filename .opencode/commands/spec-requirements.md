...
1. **Load Context**:
   - Read `.agents/specs/$1/spec.json` for language and metadata
   - Read `.agents/specs/$1/requirements.md` for project description
...
2. **Read Guidelines**:
   - Read `.agents/rules/ears-format.md` for EARS syntax rules
   - Read `.agents/templates/specs/requirements.md` for document structure
...
- Review generated requirements at `.agents/specs/$1/requirements.md`
- **Optional Gap Analysis** (for existing codebases):
  - Run `/spec-validate-gap $1` to analyze implementation gap with current code

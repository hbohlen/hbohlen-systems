...
1. **Load Context**:
   ...
   - Read `.agents/specs/$1/design.md` for design document
...
2. **Read Review Guidelines**:
   - Read `.agents/rules/design-review.md` for review criteria and process
...
- Re-validate with `/spec-validate-design $1`
